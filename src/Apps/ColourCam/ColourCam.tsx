...
export default function Loca() {
    ...
    return (
        <MantineProvider theme={{ primaryColor: 'red' }} forceColorScheme={'light'}>
                ...
                <Group justify={'space-between'}>
                    <Group>
                        <Stack>
                            ...
                            <Text c={'dimmed'}>
                                Capture snapshots of colour from the environment
                            </Text>
                        </Stack>
                    </Group>
                    <Group justify={['android', 'ios'].includes(useOs()) ? undefined : 'flex-end'}>
                        {
                            [
                                { color: 'dimmed', icon: <IconBrandGithub />, link: 'https://github.com/jarrodnorwell/colourcam' }
                            ].map((element) => {
                                return (
